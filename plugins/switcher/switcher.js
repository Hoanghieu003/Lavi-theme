...
$(function(){		
    ...
    jQuery(".skin-1").on('click',function(){
		...
		jQuery(".logo-skin img").attr("src", "images/logo.png");
        return false;
    });
    jQuery(".skin-2").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-2.css");
		jQuery(".logo-skin img").attr("src", "images/logo-2.png");
        return false;
    });
   
    jQuery(".skin-3").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-3.css");
		jQuery(".logo-skin img").attr("src", "images/logo-3.png");
        return false;
    });
	
    jQuery(".skin-4").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-4.css");
		jQuery(".logo-skin img").attr("src", "images/logo-4.png");
        return false;
    });
	
    jQuery(".skin-5").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-5.css");
		jQuery(".logo-skin img").attr("src", "images/logo-5.png");
        return false;
    });	
	
    jQuery(".skin-6").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-6.css");
		jQuery(".logo-skin img").attr("src", "images/logo-6.png");
        return false;
    });		
		
    jQuery(".skin-7").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-7.css");
		jQuery(".logo-skin img").attr("src", "images/logo-7.png");
        return false;
    });
	
    jQuery(".skin-8").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-8.css");
		jQuery(".logo-skin img").attr("src", "images/logo-8.png");
        return false;
    });	
...
/* Theme Panel Save */
	...
	themeOption['bgColor'] = ['#ff007c','#d19f68','#911439','#00aab5','#dc4437','#6c2edb','#ff0e0e','#0084ff','bgColor_value'];
	themeOption['bgImage'] =['bg1.jpg','https://lavi.dexignzone.com/xhtml/error-404.html','https://lavi.dexignzone.com/xhtml/error-404.html','https://lavi.dexignzone.com/xhtml/error-404.html','bgImage_value'];
	themeOption['bgPatten'] =['pt1.jpg','https://lavi.dexignzone.com/xhtml/error-404.html','https://lavi.dexignzone.com/xhtml/error-404.html','https://lavi.dexignzone.com/xhtml/error-404.html','https://lavi.dexignzone.com/xhtml/error-404.html','https://lavi.dexignzone.com/xhtml/error-404.html','https://lavi.dexignzone.com/xhtml/error-404.html','https://lavi.dexignzone.com/xhtml/error-404.html','https://lavi.dexignzone.com/xhtml/error-404.html','https://lavi.dexignzone.com/xhtml/error-404.html','https://lavi.dexignzone.com/xhtml/error-404.html','https://lavi.dexignzone.com/xhtml/error-404.html','bgPatten_value'];
...
function setThemePanel(){
	...
	if(logoValue != '')
	{
		jQuery(".logo-skin img").attr("src", logoValue);
	}
}
